module.exports = function(grunt) {
  grunt.initConfig({
    ...
    uglify: {
      ...
      dist: {
        src: 'dist/fidel.complete.js',
        dest: 'dist/fidel.complete.min.js'
      },
      full: {
        src: 'dist/complete.js',
    ...
    less: {
      'dist/complete.css' : 'less/default.less'
    }
  });

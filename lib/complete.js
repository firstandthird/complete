...
import { on, addClass, removeClass, toArray } from 'domassist';
...
export default class Complete extends Domodule {
  ...
  highlightItem() {
    const items = toArray(this.els.resultsContainer.querySelectorAll('li'));
  ...
  selectItem() {
    const items = this.els.resultsContainer.querySelectorAll('li');
